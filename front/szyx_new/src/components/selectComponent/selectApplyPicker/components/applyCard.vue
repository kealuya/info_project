<template>
  <div class="costCenterCard" >
    <van-row justify="space-between" align="center">
      ...
      <van-col>
        <van-icon :name="CheckedIcon" v-if="checkKey==getData.approveNo" />
      </van-col>
    </van-row>
    <div class="ml10 mt5 mb5">
      <van-row>
        <van-col><span class="f14 graytxt">申请事由：{{getData.approveReason}}</span></van-col>
      </van-row>
      <van-row>
        <van-col><span class="f14 graytxt">申请人：{{getData.creater}}</span></van-col>
      </van-row>
      <van-row>
...
import iconSelectCost from '../../../../assets/icon/icon_loan_Checked.png'
...
import {applyType} from "../../../../pages/home/component/ts/applyType";
interface Props{};
