...
export function fetchLocation(){
    return new Promise(function (resolve, reject) {
        instance({
            url:'https://restapi.amap.com/v3/ip?key=ec8838f3bf4614c5627c4266b36cc813',
            method: 'get'
...
export function fetchWeather(cityCode: string){
    return new Promise(function (resolve, reject) {
        instance({
            url:`https://restapi.amap.com/v3/weather/weatherInfo?city=${cityCode}&key=ec8838f3bf4614c5627c4266b36cc813`,
            method: 'get'
        }).then((response: object) => {
            resolve(response)
        }).catch((error :string) => {
