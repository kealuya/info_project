<template>
  ...
  <div class="page-container">
    ...
    <van-tabs v-model:active="active" @change="changeList">
      <div class="list"   :class="{ 'list1': tabIndex }">
        <van-tab title="我的任务">
...
import {getTaskList} from '../../services/task-processing/index'
...
const getListLoad = async () => {
  console.log(rwList.value.length, totalCount.value, params.value.currentPage)
  //这个判断必须加 否则会调用多次接口
