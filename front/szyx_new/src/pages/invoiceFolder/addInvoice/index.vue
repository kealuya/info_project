...
const messageUrl = 'http://124.70.111.57:7088/wsyyApp/#/pages1/page/webAddress/webAddress?'; //短信导入url
const emailUrl = 'http://124.70.111.57:7088/wsyyApp/#/pages1/page/emailImportImap/emailImport?'; //邮箱导入url
const couldUrl = 'http://124.70.111.57:7088/wsyyApp/#/pages1/page/miniWxInvoices/miniWxInvoices?'; //云票据箱url
const rpAUrl = 'http://124.70.111.57:7088/wsyyApp/#/pages1/page/emailImportSecond/emailImportSecond?'; //邮箱RPA
let url = '';
