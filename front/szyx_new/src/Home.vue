<template>
    ...
    <van-tabbar v-model="active" route>
        ...
        <van-tabbar-item icon="records" name="book" :to="{name:'book'}" replace>记账本</van-tabbar-item>
        <van-tabbar-item icon="apps-o" name="system" :to="{name:'system'}" replace>业务系统</van-tabbar-item>
