...
if(invoiceData.invoiceData.code=='identify'){
  if ((invoiceData.invoiceData.data.data.resArr[0]|| {}).fplx) {
    data = invoiceData.invoiceData.data.data.resArr[0];
    if (data.fplx == '1') {
...
const onConfirmFylb = (value: any, index: any) => {
  console.log(value)
  data.fylb = value.selectedValues
  data.pb = value.text
  if (data.fplx == '28') {
    data.bz = value.text
  }
