  ...
  <div>
    ...
    <div>
      <van-form @submit="onSubmit">
        <div class="formCard">
          <div class="pl5 f16"><span class="require">*</span>办公时间</div>
          <van-field
              v-model="outWorkDate"
              name="openCardDate"
              placeholder="请选择办公时间"
              ...
              readonly
              :rules="[{ required: true, message: '请选择办公时间' }]"
          />
        ...
        <div class="formCard">
          <div class="pl5 f16"><span class="require">*</span>办公地点</div>
          <van-field
              v-model="workPlace"
              name="workPlace"
              placeholder="请输入办公地点"
        ...
        <div class="formCard">
          <div class="pl5 f16"><span class="require">*</span>办公人员</div>
          <van-field
              v-model="officeStaff"
              name="officeStaff"
              placeholder="请输入办公人员"
              required
              :rules="[{ required: true, message: '请输入办公人员' }]"
          />
...
import {createGoOutToWork} from "../../../../services/apply";
...
import LoadingComponent from '../../../../components/loading/index.vue' //加载中组件
...
const onSubmit = async (values: any) => {
  ...
  const rowShowJson: any = [
    ...
    {'label': '外出地点', 'value': workPlace.value, 'isImportant': '1'},
    {'label': '外出人员', 'value': officeStaff.value, 'isImportant': '1'},
  ];
  const postData: any = {
    'approveNo':ywNo.value,
  ...
  loading.value=true;
  let result: any = await createGoOutToWork(postData);
