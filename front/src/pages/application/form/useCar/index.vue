...
<!--    </van-sticky>-->
    ...
    <div>
      <van-form @submit="onSubmit">
        ...
        <div class="formCard">
          <div class="pl5 f16"><span class="require">*</span>用车时间</div>
          <van-field
              v-model="outWorkDate"
              name="openCardDate"
              placeholder="请选择用车时间"
...
import {createCarApply,} from "../../../../services/apply";
...
const onSubmit = async (values: any) => {
  ...
  const carDetail: any = {
    ...
    "deptId": userInfoData.userInfo.deptId,
    "flowId": flowId.value,
    "carStartDate": startTime.value,
    "carReturnDate":endTime.value,
  ...
  const rowShowJson: any = [
    ...
    {'label': '用车时间', 'value': startTime.value, 'isImportant': '1'},
    {'label': '返回时间', 'value': endTime.value, 'isImportant': '1'},
  ];
  const postData: any = {
    'approveNo':ywNo.value,
  ...
  loading.value=true;
  let result: any = await createCarApply(postData);
