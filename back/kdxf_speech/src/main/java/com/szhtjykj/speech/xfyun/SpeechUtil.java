...
////    }
//
//    public static String upload(File audio) throws SignatureException, IOException {
...
//
//                KdxfSpeechDao kdxfSpeechDao = Solon.context().getBean(KdxfSpeechDao.class);
...
//    }
//
//    public static void getResult(String orderId, String fileName) throws SignatureException, InterruptedException {
//        HashMap<String, Object> map = new HashMap<>(16);
