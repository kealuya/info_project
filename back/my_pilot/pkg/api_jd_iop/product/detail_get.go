...
// GetDetail  查询商品详情
func GetDetail(sku, queryExts string) (*api_jd_iop.Response[DetailResult], error) {

	config := api_jd_iop.GetJdIopConfig()
	url := config["jd_iop"]["base_url"] + "product/getDetail"
	...
	resultResp := &api_jd_iop.Response[DetailResult]{}
